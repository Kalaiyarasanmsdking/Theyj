    ...
    if query.data.startswith("file"):
            ...
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                if clicked == typed:
                    await client.send_cached_media(
                        ...
                        [
                         [InlineKeyboardButton('⚡ Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ ⚡', url='https://t.me/KalaiMoviesLinkZz'),
                          InlineKeyboardButton('🔗 Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ 🔗', url='https://t.me/KalaiMoviesLinkZz')
                       ],[
                          InlineKeyboardButton("📣 Bᴏᴛ Oᴡɴᴇʀ 📣", url="t.me/MsdKalai07")
                         ]
                        ]
                    )
                )
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🔗 Subscribe YouTube Channel 🔗',
                                 url=f'https://t.me/moviesgrouptam')
        ]] 
        ...
        buttons = [[
            InlineKeyboardButton('⚡ Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ ⚡', url='https://t.me/moviesgrouptam'),
            InlineKeyboardButton('🔗 Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ 🔗', url='https://t.me/KalaiMoviesLinkZz')
        ],[
            InlineKeyboardButton('Hᴏᴍᴇ', callback_data='start'),
